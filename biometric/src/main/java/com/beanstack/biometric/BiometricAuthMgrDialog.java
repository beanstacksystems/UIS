...
public class BiometricAuthMgrDialog extends BottomSheetDialog implements View.OnClickListener {
    ...
    public BiometricAuthMgrDialog(@NonNull Context context) {
        super(context, R.style.BottomSheetDialogTheme);
        this.context = context.getApplicationContext();
        setDialogView();
    }

    public BiometricAuthMgrDialog(@NonNull Context context, BiometricCallback biometricCallback) {
        super(context, R.style.BottomSheetDialogTheme);
        this.context = context.getApplicationContext();
    ...
    public BiometricAuthMgrDialog(@NonNull Context context, int theme) {
        super(context, theme);
    }

    protected BiometricAuthMgrDialog(@NonNull Context context, boolean cancelable, OnCancelListener cancelListener) {
