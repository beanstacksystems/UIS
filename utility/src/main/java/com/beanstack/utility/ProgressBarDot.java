...
public class ProgressBarDot extends View {
    ...
    public ProgressBarDot(Context context, AttributeSet attrs) {
        super(context, attrs);

        TypedArray a = context.getTheme().obtainStyledAttributes(
                attrs,
                R.styleable.ProgressBarDot,
                0, 0);
...
//            mActiveDotColor = a.getColor(R.styleable.DottedProgressBar_activeDotColor, Color.BLUE);
            ...
            a.getValue(R.styleable.ProgressBarDot_activeDot, value);
            ...
            a.getValue(R.styleable.ProgressBarDot_inactiveDot, value);
            if (value.type >= TypedValue.TYPE_FIRST_COLOR_INT && value.type <= TypedValue.TYPE_LAST_COLOR_INT) {
                // It's a color
            ...
            mDotSize = a.getDimensionPixelSize(R.styleable.ProgressBarDot_dotSize, 5);
            mSpacing = a.getDimensionPixelSize(R.styleable.ProgressBarDot_spacing, 10);

            mActiveDotIndex = a.getInteger(R.styleable.ProgressBarDot_activeDotIndex, 0);

            mJumpingSpeed = a.getInt(R.styleable.ProgressBarDot_jumpingSpeed, 500);
