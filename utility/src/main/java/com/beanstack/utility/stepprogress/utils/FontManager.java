package com.beanstack.utility.stepprogress.utils;
    ...
    public static Typeface getTypeface(Context context, final String filePath) {
        synchronized (mFontCache) {
            try {
                ...
                Log.w("StepProgressBar", "Cannot create asset from " + filePath + ". Ensure you have passed in the correct path and file name.", e);
